<template>
    <div class="relative flex flex-col items-center justify-center w-full h-full overflow-hidden xl:flex-row md:p-20">
        <div class="z-10 w-full p-8 text-black xl:p-14 xl:mt-0 xl:w-1/2">
            <img src="images/about.jpg" class="w-[500px] h-[500px] mt-4 rounded-md lg:w-[600px] lg:h-[600px] mx-auto xl:w-auto object-cover xl:mt-0"/>
        </div>
           
        <div class="z-10 w-full p-4 text-black xl:p-4 xl:w-1/2">
            <div class="p-5 text-center xl:text-left">
                <h2 class="text-[32px] xl:text-[48px] leading-[1.2] font-bold">WHO WE ARE</h2>
        ...
        <Dots color="bg-[#383c45]" :rows="28" class="absolute w-[120px] top-5 left-5 xl:top-20 xl:left-[120px] xl:h-48"></Dots>
